...
const paths = {
    ...
    types: `${nodeModules}/@types`,
    i18n: resolveApp("src/shared/i18n"),
    publicPath: "./static/"
};

// TODO: Look into the need for `srcShared` - it may actually be needed?
paths.resolveModules = [/*paths.srcClient, paths.srcServer, paths.srcShared,*/ paths.src, nodeModules];
...
const plugins = {
    shared: [
        ...
        new CopyWebpackPlugin([{ from: `${nodeModules}/@atoll/shared/dist/index.es.css`, to: "shared-bundle.css" }])
    ],
    client: [
...
console.log();
console.log('**CONFIG FROM `webpack.renderer.config.js`**');
console.log();
